package zunder.ebs.zunderapp.Wallet;
...
public class Info extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(zunder.ebs.zunderapp.R.layout.fragment_info, container, false);
        return mView;
...
//        });
    ...
    private void linkElements() {
        walletSend = (TextView) getView().findViewById(zunder.ebs.zunderapp.R.id.gotosend);
        walletHistory = (TextView) getView().findViewById(zunder.ebs.zunderapp.R.id.walletHistory);
        balanceTextview = (TextView) getView().findViewById(zunder.ebs.zunderapp.R.id.balance);
        walletAddress = (TextView) getView().findViewById(zunder.ebs.zunderapp.R.id.walletAddress);
        settings = (TextView) getView().findViewById(zunder.ebs.zunderapp.R.id.walletSet);
        gear = (ImageView) getView().findViewById(zunder.ebs.zunderapp.R.id.gearWallet);
        arrow = (ImageView) getView().findViewById(zunder.ebs.zunderapp.R.id.arrowToWallet);
        qrCode = (ImageView) getView().findViewById(zunder.ebs.zunderapp.R.id.qrWallet);
        home = (ImageView) getView().findViewById(zunder.ebs.zunderapp.R.id.Home);
        wallet = (ImageView) getView().findViewById(zunder.ebs.zunderapp.R.id.Wallet);
        store = (ImageView) getView().findViewById(zunder.ebs.zunderapp.R.id.Store);
        map = (ImageView) getView().findViewById(zunder.ebs.zunderapp.R.id.Map);

...
public class WalletSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(zunder.ebs.zunderapp.R.layout.activity_wallet_settings);
    ...
    private void linkElements() {
        back = (ImageView) findViewById(zunder.ebs.zunderapp.R.id.arrowtowal);
        understandRisks = (RelativeLayout) findViewById(zunder.ebs.zunderapp.R.id.understanRisks);
        okayButton = (ImageView) findViewById(zunder.ebs.zunderapp.R.id.yesButton);
        showKey = (Switch) findViewById(zunder.ebs.zunderapp.R.id.showKey);
        input = (EditText) findViewById(zunder.ebs.zunderapp.R.id.inputText);

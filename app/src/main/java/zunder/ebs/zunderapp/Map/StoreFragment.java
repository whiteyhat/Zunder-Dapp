...
public class StoreFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(zunder.ebs.zunderapp.R.layout.fragment_store, container, false);
    }
    ...
    private void slideshow() {
        viewFlipper = (ViewFlipper) getView().findViewById(zunder.ebs.zunderapp.R.id.bckgrndViewFlipper1);
